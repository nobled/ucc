...
TEMPLATE(X86_JGF4,      "fld DWORD PTR %2;fcompp;fnstsw ax;test ah, 1;jne %0")
TEMPLATE(X86_JGF8,      "fld QWORD PTR %2;fcompp;fnstsw ax;test ah, 1;jne %0")

TEMPLATE(X86_JLI4,      "cmp %d1, %d2;jl %0")
TEMPLATE(X86_JLU4,      "cmp %d1, %d2;jb %0")
TEMPLATE(X86_JLF4,      "fld DWORD PTR %2;fcompp;fnstsw ax;test ah, 41h;jp %0")
TEMPLATE(X86_JLF8,      "fld QWORD PTR %2;fcompp;fnstsw ax;test ah, 41h;jp %0")

TEMPLATE(X86_JGEI4,     "cmp %d1, %d2;jge %0")
TEMPLATE(X86_JGEU4,     "cmp %d1, %d2;jae %0")
TEMPLATE(X86_JGEF4,     "fld DWORD PTR %2;fcompp;fnstsw ax;test ah, 41h;jne %0")
TEMPLATE(X86_JGEF8,     "fld QWORD PTR %2;fcompp;fnstsw ax;test ah, 41h;jne %0")

TEMPLATE(X86_JLEI4,     "cmp %d1, %d2;jle %0")
TEMPLATE(X86_JLEU4,     "cmp %d1, %d2;jbe %0")
TEMPLATE(X86_JLEF4,     "fld DWORD PTR %2;fcompp;fnstsw ax;test ah, 5;jp %0")
TEMPLATE(X86_JLEF8,     "fld QWORD PTR %2;fcompp;fnstsw ax;test ah, 5;jp %0")
...
TEMPLATE(X86_TRUI1,     "")
TEMPLATE(X86_TRUI2,     "")
TEMPLATE(X86_CVTI4F4,   "push %d1;fild DWORD PTR [esp];fstp DWORD PTR %0")
TEMPLATE(X86_CVTI4F8,   "push %d1;fild DWORD PTR [esp];fstp QWORD PTR %0")
TEMPLATE(X86_CVTU4F4,   "push 0;push %d1;fild QWORD PTR [esp];fstp DWORD PTR %0")
TEMPLATE(X86_CVTU4F8,   "push 0;push %d1;fild QWORD PTR [esp];fstp QWORD PTR %0")
TEMPLATE(X86_CVTF4,     "fld DWORD PTR %1;fstp QWORD PTR %0")
TEMPLATE(X86_CVTF4I4,   "fld DWORD PTR %1;call __ftol")
TEMPLATE(X86_CVTF4U4,   "fld DWORD PTR %1;subl esp, 16;fnstcw [esp];movzx eax, WORD PTR [esp];"
...
TEMPLATE(X86_CVTF8I4,   "fld DWORD PTR %1;call __ftol")
TEMPLATE(X86_CVTF8U4,   "fld DWORD PTR %1;subl esp, 16;fnstcw [esp];movzx eax, WORD PTR [esp];"
                        "or eax, 0c00H;mov 4[esp], eax;fldcw 4[esp];fistp QWORD PTR 8[esp];"
                        "fldcw [esp];mov eax, 8[esp];add esp, 16")
...
TEMPLATE(X86_INCF8,     "fldl fadd QWORD PTR %0;fstp QWORD PTR %0")
...
TEMPLATE(X86_DECF4,     "fld1;fsub DWORD PTR %0;fabs;fstp DWORD PTR %0")
TEMPLATE(X86_DECF8,     "fldl fsub QWORD PTR %0;fabs;fstp QWORD PTR %0")
...
TEMPLATE(X86_CLEAR,     "sub esp, 12;push %1;push 0;lea eax, %0;push eax;call _memset;add esp, 12")

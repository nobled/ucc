...
TEMPLATE(X86_CVTI4F4,  "pushl %1;filds (%%esp);fstps %0")
TEMPLATE(X86_CVTI4F8,  "pushl %1;fildl (%%esp);fstpl %0")
TEMPLATE(X86_CVTU4F4,  "pushl $0;pushl %1;fildl (%%esp);fstps %0")
TEMPLATE(X86_CVTU4F8,  "pushl $0;pushl %1;fildl (%%esp);fstpl %0")
TEMPLATE(X86_CVTF4,    "flds %1;fstpl %0")
TEMPLATE(X86_CVTF4I4,  "flds %1;subl $8, %%esp;fnstcw (%%esp);movzwl (%%esp), %%eax;"
                       "orl $0x0c00, %%eax;movl %%eax, 4(%%esp);fldcw 4(%%esp);fistpl 8(%%esp);"
                       "fldcw (%%esp);movl 8(%%esp), %%eax;addl $8, %%esp")
...
TEMPLATE(X86_CVTF8I4,  "fldl %1;subl $8, %%esp;fnstcw (%%esp);movzwl (%%esp), %%eax;"
                       "orl $0x0c00, %%eax;movl %%eax, 4(%%esp);fldcw 4(%%esp);fistpl 8(%%esp);"
                       "fldcw (%%esp);addl $8, %%esp")
